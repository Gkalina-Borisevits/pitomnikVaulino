  ...
  return (
    <div className={styles.container}>
      <img
        ...
        src={
          "https://ci4.googleusercontent.com/proxy/gwqaacJIpNjtbm_xexz1xuEjkLW4RjRgfrzp3ABmiJiy_wJRuq-woTBcxRfQmj_svSD1ezrFUguqpYgYFMBvZbODJAUTgiLGSmUmUS_B9LBP3Ike3b6ppfbchM5IZKnU1mTpxRTHEd_sxHGHmlbDsmgNc6JGI0W4MMLk1VsWHTAqlFa9PbuPVw1e1G2K3U6eeqtNMVgDZ9N2g89CyEazuXpU9g=s0-d-e1-ft#https://dynamic.brandcrowd.com/preview/logodraft/5384d0b5-b5d7-4e69-a6e2-d5a5f446873d/image/large.png?bust=b33bb0ba-dfb0-42aa-8258-fc6f65e87832"
        }
      ></img>
      ...
      <div className={styles.adresSud}>
        <ul>Краснодарский край,</ul>
        <ul>Северский р - н, </ul>
